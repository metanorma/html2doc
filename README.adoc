...
This generates .doc documents. We are yet to review https://github.com/MuhammetDilmac/Html2Docx and https://github.com/jetruby/puredocx, which may well do the same job.
